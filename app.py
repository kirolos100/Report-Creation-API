...
انا اريد json file مفصلا و وشارحا باستفاضة بدون ذكر المصدر في كل نقطة يحتوي على:
      headings: [ لاحظ ان الheadings تحتوي على list كبيرة التي تحتوي على listItmesList list & listItems list
          ...
          listItemsList: [
              listItems: [
                  title: عنوان النقطة,
                  content: محتوى تلك النقطة مكتوبا ب HTML tags انا اريد جملة واحدة فقط لا غير توضح تلك محتوى تلك النقطة و تلك الجملة يجب ان تبدا ب "هذه النقطة لهذا العنوان ستتحدث عن ..." يجب ان يكون محتوى تلك النقطة يحمل توقعات مستقبلية في ظل تلك الجملة الواحدة
